...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.Certificate", b =>
                {
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.Answer", b =>
                {
                    b.HasOne("final_project_be_Domain.Models.Question", "Question")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.Assignment", b =>
                {
                    b.HasOne("final_project_be_Domain.Models.Lesson", "Lesson")
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.Category", b =>
                {
                    b.HasOne("final_project_be_Domain.Models.Category", "ParentCategory")
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.Certificate", b =>
                {
                    b.HasOne("final_project_be_Domain.Models.Courses", "Course")
                        .WithOne("Certificate")
                        .HasForeignKey("final_project_be_Domain.Models.Certificate", "CertificateId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.Comment", b =>
                {
                    b.HasOne("final_project_be_Domain.Models.Comment", "ParentComment")
                        .WithMany("Comments")
                        .HasForeignKey("ParentCommentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("final_project_be_Domain.Models.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.CourseCoupon", b =>
                {
                    b.HasOne("final_project_be_Domain.Models.Coupon", "Coupons")
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.Courses", b =>
                {
                    b.HasOne("final_project_be_Domain.Models.Category", "Category")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.Lesson", b =>
                {
                    b.HasOne("final_project_be_Domain.Models.Module", "Module")
                        .WithMany("Lessons")
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.Mentor", b =>
                {
                    b.HasOne("final_project_be_Domain.Models.User", "User")
                        .WithOne("Mentor")
                        .HasForeignKey("final_project_be_Domain.Models.Mentor", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.Messages", b =>
                {
                    b.HasOne("final_project_be_Domain.Models.Mentor", "Mentors")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.PaymentPlan", b =>
                {
                    ...
                    b.HasOne("final_project_be_Domain.Models.MembershipPlan", "MembershipPlan")
                        .WithMany("PaymentPlans")
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.PollOptionVote", b =>
                {
                    b.HasOne("final_project_be_Domain.Models.PollOption", "PollOption")
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.Post", b =>
                {
                    ...
                    b.HasOne("final_project_be_Domain.Models.Post", "ParentPost")
                        .WithMany()
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.ReportComment", b =>
                {
                    b.HasOne("final_project_be_Domain.Models.Comment", "Comment")
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.ReportWorkShop", b =>
                {
                    ...
                    b.HasOne("final_project_be_Domain.Models.WorkShop", "WorkShop")
                        .WithMany("ReportWorkShops")
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.Transaction", b =>
                {
                    b.HasOne("final_project_be_Domain.Models.User", "Users")
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.UserAnswer", b =>
                {
                    b.HasOne("final_project_be_Domain.Models.Answer", "Answer")
                        .WithMany("UserAnswers")
                        .HasForeignKey("AnswerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("final_project_be_Domain.Models.UserLesson", "UserLesson")
                        .WithMany("UserAnswer")
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.UserAssignment", b =>
                {
                    b.HasOne("final_project_be_Domain.Models.Assignment", "Assignment")
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.UserMetadata", b =>
                {
                    b.HasOne("final_project_be_Domain.Models.User", "User")
                        ...
                        .HasForeignKey("final_project_be_Domain.Models.UserMetadata", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.UserRole", b =>
                {
                    b.HasOne("final_project_be_Domain.Models.Role", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("final_project_be_Domain.Models.UserSchedule", b =>
                {
                    b.HasOne("final_project_be_Domain.Models.Schedule", "Schedule")
